...
ADMINS = [(email, email) for email in EMAIL_ADMIN_LIST]
...
EMAIL_BLACKLIST = ENV.list('EMAIL_BLACKLIST', default=[])
ACCOUNT_REQUEST_NOTIFY = ENV.list('ACCOUNT_REQUEST_NOTIFY', default=[])